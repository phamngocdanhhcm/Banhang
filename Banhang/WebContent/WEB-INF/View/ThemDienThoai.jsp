                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="card-title">
                                        <div class="title">Thêm mới điện thoại.</div>
                                    </div>
                                </div>
                                <div class="panel-body">
                                <form action="ThemDienThoaiController" method = "POST" enctype="multipart/form-data">
                                <%=request.getAttribute("mess")!=null?request.getAttribute("mess"):" " %>
                                    
                                    <div class="sub-title">Tên</div>
                                    <div>
                                        <textarea class="form-control" name="name" placeholder="Tên điện thoại"></textarea>
                                    </div>
                                    ...
                                    <div>
                                        <textarea class="form-control" name="moredetail" placeholder="More Detail"></textarea>
                                    </div>
                                    ...
                                    <div>
                                    <input class="form-control" type="number" name="memory" placeholder="memory"/>
                                    </div>
