                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="card-title">
                                        <div class="title">Danh sách Ipad.</div>
                                    </div>
                                </div>
                                <div class="panel-body">
                                <form action="ThemIpadController" method = "get">
                                ...
                                <table border=2 align="center">
								 	...
								 	<c:forEach items="${list}" var="ipad" varStatus ="idx">
								 		<tr>
								 			<td>${ipad.maipad}</td>
								 			<td>${ipad.name}</td>
								 			<td>${ipad.brand}</td>
								 			<td>${ipad.dungluong}</td>
								 			<td>${ipad.hedieuhanh}</td>
								 			<td>${ipad.ram}</td>
								 			<td>${ipad.detail}</td>
								 			<td>${ipad.soluong}</td>
								 			<td>${ipad.giatien1}</td>
								 			<td><img src="data:image/jpg;base64,${ipad.hinhanh}" width="250" height="250"/> </td>
								 			
								 			<td><a href="ThemIpadController?action=xoa&id=${ipad.maipad}">Xóa</a> 
								 				<a href="SuaipadController?action=sua&id=${ipad.maipad}">Sửa</a> 
								 			 </td>
