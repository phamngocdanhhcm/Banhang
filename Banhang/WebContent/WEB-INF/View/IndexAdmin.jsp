...
<body>
    ...
    <!-- Morris Chart Js -->
    <script src="Template/Backend/assets/js/morris/raphael-2.1.0.min.js"></script>
    <script src="Template/Backend/assets/js/morris/morris.js"></script>
	
	
	<script src="Template/Backend/assets/js/easypiechart.js"></script>
	<script src="Template/Backend/assets/js/easypiechart-data.js"></script>
	
	 <script src="Template/Backend/assets/js/Lightweight-Chart/jquery.chart.js"></script>
    ...
    <!-- Chart Js -->
    <script type="text/javascript" src="Template/Backend/assets/js/Chart.min.js"></script>  
    <script type="text/javascript" src="Template/Backend/assets/js/chartjs.js"></script> 
</body>
</html>