...
<body>
		...
		<%
			...
			List<Ipad> arr = daoipad.getAll(conn);
			int start = 0 , end = 9;
			if(arr.size() < 9)
			{
				end = arr.size();
			...
			List<Ipad> list = daoipad.getListByPage(arr, start, end);
			List<Ipad> list1 = daoipad.getProductRandom();
			
			List<Ipad> list2 = daoipad.getProductSeller();
		%>
			...
			<section class="main-content">
				...
				%>		
							...
							<div class="product-box">
								...
								<p><a href="Productdetail_Controller?action=ipad&id=<%=ipad.getMaipad() %>"><img src="data:image/jpg;base64,<%=ipad.getHinhanh() %>" width="250" height="250" alt="" /></a></p>
								<a href="Productdetail_Controller?action=ipad&id=<%=ipad.getMaipad() %>" class="title"> <%=ipad.getName() %></a><br/>
								<a href="Productdetail_Controller?action=ipad&id=<%=ipad.getMaipad() %>" class="category"><%=ipad.getHedieuhanh() %> </a>
				...
				%>  
						...
						<ul class="pagination">
							...
							%>
							<li> <a href="IpadForward?start=<%=a%>&end=<%=b%>"><%=i%></a></li>
							<%
								}
							%>
						</ul>						
					...
					<div class="span3 col">
						...
						<div class="block">								
							...
							%>
								<li>
									<a href="Productdetail_Controller?action=ipad&id=<%=ipad.getMaipad() %>" title="">
										<img src="data:image/jpg;base64,<%=ipad.getHinhanh() %>" width="250" height="250" alt="">
									</a>
									<a href="Productdetail_Controller?action=ipad&id=<%=ipad.getMaipad() %>"><%=ipad.getName()%></a>
								</li>
								<%
								}%>
