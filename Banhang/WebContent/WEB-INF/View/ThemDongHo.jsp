                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="card-title">
                                        <div class="title">Thêm mới đồng hồ.</div>
                                    </div>
                                </div>
                                <div class="panel-body">
                                <form action="ThemDongHoController" method="POST" enctype="multipart/form-data">
                                <%=request.getAttribute("mess")!=null?request.getAttribute("mess"):" " %>
                                
                                    <div class="sub-title">Tên</div>
                                    <div>
                                        <textarea class="form-control" name="name" placeholder="Tên đồng hồ"></textarea>
                                    </div>
                                    ...
                                    <div>
                                        <textarea class="form-control" name="manhinh" placeholder="Màn hình"></textarea>
                                    </div>
                                    <div class="sub-title">Công nghệ màn hình</div>
                                    <div>
                                        <textarea class="form-control" name="congnghemanhinh" placeholder="Công nghệ màn hình"></textarea>
                                    </div>
                                    ...
                                    <div>
                                        <textarea class="form-control" name="detail" placeholder="More Detail"></textarea>
                                    </div>
                                    <div class="sub-title">Số lượng</div>
                                    <div>
                                        <input type="number" class="form-control" name="soluong" placeholder="Số lượng">
                                    </div>
                                    <div class="sub-title">Giá tiền</div>
                                    <div>
                                        <input type="number" class="form-control" name="gia" placeholder="Giá tiền">
                                    </div>
